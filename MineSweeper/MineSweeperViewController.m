...
- (void)viewDidLoad
{
    ...
    [manager newGameWithNumRows:MINESWEEPER_CONFIG_ROWS numColumns:MINESWEEPER_CONFIG_COLUMNS numMines:MINESWEEPER_CONFIG_NUM_MINES];
    
    // Create and configure the scene.
    MineSweeperScene *scene = [[MineSweeperScene alloc] initWithSize:self.view.frame.size];
